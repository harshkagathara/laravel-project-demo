...
class CouponsController extends Controller
{
    ...
    { 
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        $btn ='<a href="coupon/edit/'. $row->id .'">
                        <button type="button" class="btn" style="background-color: #8141a1;">
                        <i class="fas fa-pencil-alt" style="color: white;"></i>
                        </button>
                        </a>
                        <a  href="coupon/delete/'. $row->id .'" onclick="return confirm(\'Are You Sure Want to Delete?\')">
                        <button type="button" class="btn" style="background-color: #8141a1;" >
        ...
        return view('restaurant-owner/coupons/index');
    ...
    {   
        ...
        return view('restaurant-owner/coupons/create',compact('restaurants'));
    }
    ...
    public function EditCoupons($id)
    {
        ...
        return view('restaurant-owner/coupons/edit',compact('coupons','restaurants'));
    }
    public function UpdateCoupons(Request $request)
    {
        ...
        return redirect('/restaurant-owner/coupons')->with('Msg_coupon_Edit','Edited Successfully');
    }
    public function DeleteCoupons($id)
    {  
        $coupons = DB::table('coupons')->where('id',$id)->delete();
        return redirect('/restaurant-owner/coupons')->with('Msg_coupon_Edit','Dishes Delete Successfully');
    }
}
