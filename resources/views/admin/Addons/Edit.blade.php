...
<div class="row">
	<div class="col-12">
		...
		<div class="card" style="margin-top: 10px;">
			...
			<!-- /.card-header -->
			<!-- form start -->
			<form role="form" id="createForm" method="POST" action="{{route('update.addons')}}" enctype="multipart/form-data">
				@csrf		
    ...
    @foreach($restaurants as $restaurant) 
            <option value="{{$restaurant->id}}" {{$addons->restaurant_id == $restaurant->id ? 'selected' : ''}}>
