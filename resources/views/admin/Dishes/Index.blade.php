...
<div class="content-header" style="display: flex;">
    ...
    <div class="container-fluid" style="display: flex;">
        ...
        <h1 class="m-0 text-dark" style="font-weight: 700;">Dishes</h1>
        <p style="color: grey;">Manage all restaurants dishes</p>
    </div>
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          <button type="button" class="btn btn-block  btn-sm" style="background: #8141a1;color: white;">Add a Dish</button>
          </a>
        </div>
      </div>
      <!-- /.card-header -->
