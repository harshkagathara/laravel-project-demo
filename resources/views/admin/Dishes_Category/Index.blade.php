    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="{{route('admin.dish_category.create')}}">
          <button type="button" class="btn btn-block  btn-sm" style="background: #8141a1;color: white;">Add a Dish Category</button>
          </a>
        </div>
      </div>
      <!-- /.card-header -->
...
<!-- /.row -->
  ...
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.dish_categories') }}",
        columns: [
