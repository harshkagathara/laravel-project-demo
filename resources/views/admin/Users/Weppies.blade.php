...
<div class="content-header" style="display: flex;">
    ...
    <div class="container-fluid" style="display: flex;">
        ...
        <div style="padding: auto 0px;">
					<h1 class="m-0 text-dark">Wepppies</h1> 
          <p style="color: grey;">Manage all Wepppies</p>
        </div>
    </div>
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h1 class="card-title mt-2">List of Wepppies</h1>
        <div class="card-tools">
          <!-- <a href="#">
          <button type="button" class="btn btn-block btn-sm	" style="color: white; background:#8141a1">Add  Wepppies</button>
