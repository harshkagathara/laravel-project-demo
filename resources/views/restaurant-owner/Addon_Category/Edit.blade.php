...
<div class="content-header" style="display: flex;">
    ...
    <div class="container-fluid" style="display: flex;">
        ...
        <div style="padding: auto 0px;">
         <h1 class="m-0 text-dark" style="font-weight: 700;">Edit Extra Category</h1>
         </div>
         </div>
</div>
	...
	<div class="col-12">
		...
		<div class="card" style="margin-top: 10px;">
			<!-- <div class="card-header" style="background:#8141a1">
				<h3 class="card-title" style="color: white;">Edit Addon Category</h3>
			</div> -->
			<!-- /.card-header -->
			<!-- form start -->
			<form role="form" id="createForm" method="POST" action="{{route('update.category-res')}}"
				enctype="multipart/form-data">
				@csrf
				<input type="hidden" name="id" value="{{$addons_categories->id}}">
						<div class="card-body">
