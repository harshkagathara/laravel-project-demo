...
<div class="content-header" style="display: flex;">
    ...
    <div class="container-fluid" style="display: flex;">
        ...
        <h1 class="m-0 text-dark" style="font-weight: 700;">Extras</h1>
        <p style="color: grey;">Manage all Extras</p>
        </div>
    </div>
...
@if (Session::has('Msg_Addon_Edit'))
  <div class="alert alert-success alert-dismissible fade show" id="success-alert">
    <button type="button" class="close" data-dismiss="alert">&times;</button>
      {{Session::get('Msg_Addon_Edit')}}
    </div>  
@endif 
<script>
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h1 class="card-title mt-2">List of Extras</h1>
        <div class="card-tools">
          <a href="{{route('restaurant-owner.addons.create')}}">
          <button type="button" class="btn btn-block  btn-sm" style="background: #8141a1;color: white;">Add Extra</button>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('restaurant-owner.dish_addons') }}",
        columns: [
