...
<div class="row">
	<div class="col-12">
		...
		<div class="card" style="margin-top: 10px;">
			<!-- <div class="card-header" style="background:#8141a1">
				<h3 class="card-title" style="color: white;">Create a Coupon</h3>
			</div> -->
			<!-- /.card-header -->
			<!-- form start -->
			<form role="form" id="createForm" method="POST" action="{{route('save.coupon-res')}}">
    ...
    <div class="col-sm-9 input-wrapper">
    <select name=discount_type class="form-control select2" style="width: 100%;" >
                <option value="FIXED" >
